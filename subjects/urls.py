...
from .views import SubjectListView, group_template_list, LessonCreateView, LessonDetailView, search_students, \
    ...
    tasks_view, weekly_schedule_view, psy_appointment_view, group_templates_view, EditGroupTemplateView,  VolunteerChannelListAPIView, UserSearchAPIView
...
urlpatterns = [
    ...
    path('api/search-users/', UserSearchAPIView.as_view(), name='api-search-users'),
    path('api/volunteer-channels/', VolunteerChannelListAPIView.as_view(), name='api-volunteer-channels'),
